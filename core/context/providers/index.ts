...
import HttpDocsContextProvider from "./HttpDocsContextProvider";
import HttpDocs2ContextProvider from "./HttpDocs2ContextProvider";
import HttpDocs3ContextProvider from "./HttpDocs3ContextProvider";
...
export const Providers: (typeof BaseContextProvider)[] = [
  ...
  HttpDocsContextProvider,
  HttpDocs2ContextProvider,
  HttpDocs3ContextProvider
];
